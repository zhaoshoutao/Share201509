(function (){
    //数据源
    var ary=["img/56cbf70eNea547e20.jpg","img/56cc1dd9N1cb867dc.jpg","img/56cd1f72N174258f2.jpg","img/56cd1f91Nb2666b81.jpg"];
    //定义几个初始的变量
    ...
    function bindData(){
        ...
        inner.innerHTML=str;
        inner.style.width=(count+1)*753+"px";
        //焦点
        str="";
        for(var i=0;i<ary.length;i++){
            str+="<li></li>"
    ...
    function tipMove(){
        for(var i=0;i<tipList.length;i++){
            ...
            curTip.onclick=function (){
                ...
                step=this.index;
                animate(inner,{left:-step*753},500);
                selectTip();
